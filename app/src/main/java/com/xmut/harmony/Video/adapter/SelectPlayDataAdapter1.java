...
public class SelectPlayDataAdapter1 extends RecyclerView.Adapter<SelectPlayDataAdapter1.PlayViewHolder> {
     ...
     */
    public SelectPlayDataAdapter1(Context context, OnItemClickListener onItemClickListener) {
    ...
    public PlayViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.gridvideolayout, parent, false);
